...
const About = () => {
  ...
  return (
    <section id="about" className="text-white w-full mb-32">
      ...
      <div>
        <h2 ref={descRef} className="text-sm sm:text-base font-medium text-priText leading-normal mb-14">
        ...
        <div ref={technoRef} className="technologies mt-12">
          ...
          <div className="mt-4 flex items-center justify-start flex-wrap gap-2">
            <p className="text-darkBlue text-xs sm:text-sm font-semibold px-2 py-1 bg-secBg inline rounded">
              HTML
            </p>
            <p className="text-darkBlue text-xs sm:text-sm font-semibold px-2 py-1 bg-secBg inline rounded">
              CSS
