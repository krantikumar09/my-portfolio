...
const Hero = () => {
  ...
  return (
    <>
      ...
      <div
        id="hero"
        className="flex items-start flex-col justify-between py-12 text-white h-screen"
      >
        <div ref={headRef} className="flex  flex-col">
          <h1 className="text-priText text-4xl font-bold mb-2">
            <span className="text-green">Hi!</span> I'm Krantikumar Mathapati
          </h1>
          <h4 className="text-priText text-xl font-semibold mb-6">
